      ...
      <div className="grid xl:grid-cols-3 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 place-items-center gap-5 mt-20">
        {listExperience.map((item, index) => {
          return (
            <div
              key={index}
              className="px-20 py-14 h-full bg-slate-400 dark:bg-slate-700 dark:bg-opacity-60 bg-opacity-80  hover:bg-black hover:bg-opacity-50 border hover:border-light-blue rounded-lg transition-all ease-in-out delay-150">
